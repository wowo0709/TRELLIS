...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--gt_dir",
        type=str,
        default="/root/data/shape-generation/3D-FRONT/3D-FRONT-processed_bedroom-noair/bedrooms_without_lamps_full_images/images_256_zuniform-h3-r5_noair/test"
    )
    parser.add_argument(
        "--gen_dir",
        type=str,
    ...
    parser.add_argument(
        "--cache_root",
        type=str,
        default=str(Path(__file__).resolve().parents[2] / ".cache" / "evaluate_diffusion_front3d"),
