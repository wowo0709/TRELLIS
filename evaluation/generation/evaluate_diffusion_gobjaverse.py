...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--gt_dir",
        type=str,
        default="/root/data/shape-generation/gobjaverse/gobjaverse_280k_category/Animals_subset",
    )
    parser.add_argument(
        "--gen_dir",
        type=str,
    ...
    parser.add_argument(
        "--cache_root",
        type=str,
        default=str(Path(__file__).resolve().parents[2] / ".cache" / "evaluate_diffusion_gobjaverse"),
