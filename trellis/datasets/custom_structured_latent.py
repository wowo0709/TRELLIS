...
class CustomSLatVisMixin:
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(roots, data_type, data_category, *args, **kwargs)
        self.slat_dec = None
...
class CustomSLat(CustomSLatVisMixin, CustomStandardDatasetBase):
    """
    ...
    def get_instance(self, root, instance):
        data = np.load(os.path.join(root, instance, f'slat.npz'))
...
class CustomTextConditionedSLat(CustomTextConditionedMixin, CustomSLat):
    """
...
class CustomImageConditionedSLat(CustomImageConditionedMixin, CustomSLat):
    """
